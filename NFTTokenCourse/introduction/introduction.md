...
区块链技术所具备革命性创新之处在于它允许数据以不可变（无法更改）方式公开存储。这种新的数据存储形式使我们能够跟踪所有权,并首次实现真正可控制的数字项目。
...
最流行的代币标准是 ERC20 用于同质化代币和 ERC721 用于非同质化代币。在本课程中,我们将学习如何创建和交互 NFT,即使用 ERC721 代币标准创建的代币。
